...
const CAT_GALLERY_KEY = "pawCatGallery_v2";
...
function isBaseCanvasEmpty() {
    const blankCanvas = document.createElement('canvas');
    blankCanvas.width = baseCanvas.width;
    blankCanvas.height = baseCanvas.height;
    const blankCtx = blankCanvas.getContext('2d');
    blankCtx.fillStyle = "#ffffff";
    blankCtx.fillRect(0, 0, blankCanvas.width, blankCanvas.height);
    return baseCanvas.toDataURL() === blankCanvas.toDataURL();
}
