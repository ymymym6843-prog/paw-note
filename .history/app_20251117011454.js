...
const catOptionLabels = {
  ...
  hat: { "none": "없음", "hat_navy_knit": "네이비", "hat_pink_knit": "핑크", "hat_skyblue_knit": "스카이블루" },
  accessory: { "none": "없음", "acc_baseball": "야구 모자", "acc_bow_tie": "보타이", "acc_churu": "츄르", "acc_crown": "왕관", "acc_green_knit": "초록 니트", "acc_hairpin": "머리핀", "acc_mouse_toy": "쥐 장난감", "acc_rabbit-doll": "토끼 인형", "acc_teddy_bear": "곰 인형", "acc_yarnball": "실뭉치" },
};
const catPartLabels = {
